"""This module is used in conjuction with our other modules to make a list of all log files."""
...
def get_log_files():
	"""
	This method returns all log files as a list

	Returns
	-------
	l : list
		This contains all log files
	"""
	l = sorted(log_directory_path.glob("*.statlog"), reverse=False)
	if len(l) == 0:
		return None
	return l
...
if __name__ == "__main__":
    ...
    try:
    	...
    	print("None type error is uniterable")
